...
> All tasks follow the three-phase workflow: Research (`research.md`) → Plan (`plan.md`, annotate 1–6 times) → Implement. No code until the plan is approved.
...
- Use code execution for coordinate math — don't reason through row offsets and index mapping mentally
...
- **Dependencies**: Hardware running (Tasks 1-2); `artist` evaluation — don't self-assess parity, this is a visual judgment call
